public class FizzBuzz {
    /**
     * Basic org.WhittenJ.FizzBuzz.FizzBuzz Solution
     * @param num Integer being evaluated
     * @return Return org.WhittenJ.FizzBuzz.FizzBuzz if num is a multiple of 3 AND 5.  Fizz if only a multiple of 3. Buzz if only a multiple of 5.
     */
    ...
    /**
     * Better Basic org.WhittenJ.FizzBuzz.FizzBuzz Solution
     * @param num Integer being evaluated
     * @return Return org.WhittenJ.FizzBuzz.FizzBuzz if num is a multiple of 3 AND 5.  Fizz if only a multiple of 3. Buzz if only a multiple of 5.
     */
    ...
    /**
     * More Advanced org.WhittenJ.FizzBuzz.FizzBuzz Solution.  A bit harder to read though.
     * @param num Integer being evaluated
     * @return Return org.WhittenJ.FizzBuzz.FizzBuzz if num is a multiple of 3 AND 5.  Fizz if only a multiple of 3. Buzz if only a multiple of 5.
     */
